        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Create New Tour Package</h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('tour_operator.packages.store') }}" method="POST">
                        @csrf
                            ...
                            <select class="form-select @error('destination_id') is-invalid @enderror" 
                                ...
                                @foreach($destinations as $destination)
                                    <option value="{{ $destination->destination_id }}" 
                                            {{ old('destination_id') == $destination->destination_id ? 'selected' : '' }}>
                                        {{ $destination->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('total_available_slots') }}" 
                                       min="1" 
                                       required>
